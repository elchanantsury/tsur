  ...
  return (
    <div style={{
      ...
      <nav style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        <Link hr{linkStyle('/work-log')}><span>📅</span> יומן עבודה</Link>
        ...
        {isAdmin && (
          <div style={{ marginTop: '16px', paddingTop: '16px', borderTop: '1px solid #d1fae5' }}>
            ...
            <Link href="/admin/users" style={linkStyle('/admin/users', '#f59e0b')}><span>⚙️</span> ניהול משתמשים</Lin, borderRadius: '12px',
